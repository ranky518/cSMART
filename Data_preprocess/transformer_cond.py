...
class TransformerCond(nn.Module):
    # Rename mask_id -> padding_idx_id internally for clarity
    def __init__(self, vocab_size, num_users, embed_dim=512,
                 nhead=8, num_layers=6, mask_id=None, max_len=288):
        super().__init__()
        # Note: 'mask_id' here essentially sets the Padding Index for embedding
    ...
    def forward(self, token_id, time_feat, user_id):
        ...
        # Make sure we mask PAD tokens, but NOT MASK tokens
